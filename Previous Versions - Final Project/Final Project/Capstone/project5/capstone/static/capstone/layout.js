...
// Function to handle smooth scrolling to a specific div
...
// Add an event listener to the contactMe link
document.getElementById('timelinescroll').addEventListener('click', function(event) {
    event.preventDefault(); // Prevent default anchor behavior
    scrollToDiv('timelineContent'); // Scroll to the target div with ID 'contact-section'
});

// Add an event listener to the referral link
document.getElementById('referralscroll').addEventListener('click', function(event) {
    event.preventDefault(); // Prevent default anchor behavior
    scrollToDiv('referralsContent'); // Scroll to the target div with ID 'referral-section'
});

// Add an event listener to the messages link
document.addEventListener('DOMContentLoaded', function() {
    // Check if the element with ID 'messagescroll' exists
    const messageScroll = document.getElementById('messagescroll');
    if (messageScroll) {
        // If it exists, add the event listener
        messageScroll.addEventListener('click', function(event) {
            event.preventDefault(); // Prevent default anchor behavior
            scrollToDiv('messageContent'); // Scroll to the target div with ID 'referral-section'
        });
    }
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Event listener to trigger modal display
    var timelinePostButton = document.getElementById('timelinePost');
    if (timelinePostButton) {
        timelinePostButton.addEventListener('click', function(event) {
            event.preventDefault(); // Prevent default link behavior
